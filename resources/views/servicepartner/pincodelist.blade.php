                            ...
                            <div class="col-auto">
                                <select name="product_type" class="form-control" id="product_type">
                                    ...
                                    <option value="chimney" @if($product_type == 'chimney') selected @endif>Product Type - Chimney</option>
									 <option value="gas_stove" @if($product_type == 'gas_stove') selected @endif>Product Type - Gas Stove</option>
									 <option value="ac" @if($product_type == 'ac') selected @endif>Product Type - Ac</option>
									 <option value="gieger" @if($product_type == 'gieger') selected @endif>Product Type - Geyser</option>
                                </select>
