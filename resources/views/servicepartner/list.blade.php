            ...
            <tr>
                ...
                <td data-colname="Name" class="primary_column">
                    <p class="small text-muted mb-1">
                        ...
                        @endif
                        @if ($item->service_partner_head == 99)
                        <span class="badge rounded-pill bg-secondary">Service Head</span>
                        @endif
                ...
                <td data-colname="Action">
                    ...
                    <a href="{{route('service-partner.change-password', [Crypt::encrypt($item->id),Request::getQueryString()])}}" class="btn btn-outline-primary select-md">Change Password</a>
                    ...
                    <a href="{{ route('service-partner.pincodelist', Crypt::encrypt($item->id)) }}" class="btn btn-outline-primary select-md">PIN Codes ({{count($item->pincodes)}}) </a>
                    ...
                    @if(!empty($item->status))
                        <form action="{{route('service-partner.toggle-status', [Crypt::encrypt($item->id),Request::getQueryString()])}}" method="GET">
