...
<section>
    <ul class="breadcrumb_menu">
        ...
        <li><a href="{{ route('dealer-purchase-order.show', Crypt::encrypt($id)) }}">{{$order_no}}</a></li>        
        <li>Barcodes</li>
            ...
            <div class="col-auto">
                ...
                <div class="row g-3 align-items-center">  
                    <div class="col-auto">
                        ...
                        <a href="{{ route('dealer-purchase-order.barcode-csv',Crypt::encrypt($id)) }}?search={{$search}}" id=""  class="btn btn-outline-primary select-md">Export Barcode CSV</a>
