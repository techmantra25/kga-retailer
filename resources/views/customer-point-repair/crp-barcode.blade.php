@extends('layouts.app')
@section('content')
@section('page', 'Product CRP-Barcode')
<section>
    <ul class="breadcrumb_menu">        
        <li>CUSTOMER REPAIR BARCODE</li>
    </ul>    
            ...
            <div class="col-auto">
                <div class="row g-3 align-items-center">  
                    <div class="col-auto">
                        ...
                        <a href="{{ route('customer-point-repair.list-booking') }}" class="btn btn-outline-danger select-md">Back</a>
            ...
            <div class="" id="print_div">
                <div class="col-12 page_bar">
                    ...
                    <img class="" alt="Barcoded value {{$data->unique_id}}" src="https://bwipjs-api.metafloor.com/?bcid=code128&text={{$data->unique_id}}&height=6&textsize=14&scale=6&includetext">
                    <span>Customer Repair product</span>
                    </div>
                </div>
            </div>
</section>
