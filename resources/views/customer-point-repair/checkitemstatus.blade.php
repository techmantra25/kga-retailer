                    ...
                    <div class="col-sm-12">
                            ...
                            <tbody>
                                <tr>
                                    <td width="25%">
                                        ...
                                        <p class="small text-muted mb-1">
                                            Product Name: <strong>{{ $data->product->title ?? 'N/A' }}</strong>
                                        </p>
                                        <p class="small text-muted mb-1">
                                            Customer Name: <strong>{{ $installation->customer_name ?? 'N/A' }}</strong>
                                        </p>
                                        <p class="small text-muted mb-1">
                                            Installation Id: <strong>{{ $installation->unique_id ?? 'N/A' }}</strong>
                                        </p>
                                        <p class="small text-muted mb-1">
                                            Installation Date: <strong>{{ $installation->entry_date ?? 'N/A' }}</strong>
                                        </p>
                                        <p class="small text-muted mb-1">
                                            Bill No: <strong>{{ $installation->bill_no ?? 'N/A' }}</strong>
                                        </p>
                                        <p class="small text-muted mb-1">
                                            Mobile: <strong>{{ $installation->mobile_no ?? 'N/A' }}</strong>
                                        </p>
                                        <p class="small text-muted mb-1">
                                            Phone: <strong>{{ $installation->phone_no ?? 'N/A' }}</strong>
                                        </p>
                                        <p class="small text-muted mb-1">
                                            Address: <strong>{{ $installation->address ?? 'N/A' }}</strong>
                                        </p>
                                        <p class="small text-muted mb-1">
                                            Pincode: <strong>{{ $installation->pincode ?? 'N/A' }}</strong>
                                        </p>
                                        <p class="small text-muted mb-1">
                                            Branch: <strong>{{ $installation->branch ?? 'N/A' }}</strong>
                                        </p>
                                    </td>
                                    <td>
                                        <div class="row">
                        ...
                        <div class="text-end">
                            <form action="{{ route('customer-point-repair.add-call-request') }}" method="GET">
                                ...
                                <input type="hidden" name="mobile" value="{{$installation?$installation->mobile_no:''}}">
                                <input type="hidden" name="phone" value="{{$installation?$installation->phone_no:''}}">
                                <input type="hidden" name="address" value="{{$installation?$installation->address:''}}">
                                <input type="hidden" name="bill_date" value="{{$installation?$installation->entry_date:''}}">
                                <input type="hidden" name="bill_no" value="{{$installation?$installation->bill_no:''}}">
                                <input type="hidden" name="pincode" value="{{$installation?$installation->pincode:''}}">
                                <input type="hidden" name="customer_name" value="{{ $installation?$installation->customer_name:''}}">
