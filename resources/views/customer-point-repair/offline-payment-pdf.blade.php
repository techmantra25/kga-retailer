  ...
  <table style="border: 1px solid black; width: 700px; margin: auto; font-family: Arial, sans-serif; border-collapse: collapse;">
    <tr>
      <td colspan="6" style="padding: 10px; vertical-align: top;">
        ...
        <p style="margin: 5px 0;">Phone: +91-6291117317</p>
        <p style="margin: 5px 0;">E-mail: <a href="mailto:kgaelectronics@gmail.com">kgaelectronics@gmail.com</a></p>
        <p style="margin: 5px 0;">Website: <a href="http://www.kgaelectronics.com" target="_blank">www.kgaelectronics.com</a></p>
      </td>
      <td colspan="3" style="padding: 10px; vertical-align: top; text-align: right;">
        <p style="margin: 5px 0;">GSTIN: <b>19ABOFA0730E1ZO</b></p>
        <p style="margin: 5px 0;">PAN No: <b>ABOFA0730E</b></p>
      </td>
    </tr>
    <tr>
      <td colspan="9" style="padding: 10px;">
        <p style="margin: 0;"><b>CUSTOMER:</b> {{$crp_data->customer_name}}</p>
        <p style="margin: 0;padding: 10px 0;"><b>Address:</b> {{$crp_data->address}}</p>
        <p style="margin: 0;"><b>Phone:</b> {{$crp_data->alternate_no}}</p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="4" style="border: 1px solid black; padding: 10px; vertical-align: top;">
        ...
        <p><b>Name :</b> {{ $crp_data->servicePartner?$crp_data->servicePartner->person_name:"" }}</p>
        <p><b>Contact No :</b> {{ $crp_data->servicePartner?$crp_data->servicePartner->phone:"" }}</p>
    ...
    <tr style="text-align: center; font-weight: bold;">
      <td style="border: 1px solid black; padding: 3px;">Spares Description & Sl. No.</td>
    ...
    @endphp
        ...
        <td style="border: 1px solid black; color: red;padding: 3px;">{{ $item->productData?$item->productData->title:""}} (As per scan)</td>
    ...
    <tr style="font-weight: bold; text-align: left;padding: 3px;">
      <td colspan="1" style="border: 1px solid black;padding: 3px;">Total Taxable Amount</td>
      ...
      <td colspan="2" style="border: 1px solid black;padding: 3px;text-align: center;">Total Tax </td>
      <td colspan="1" style="border: 1px solid black;padding: 3px;">{{number_format(($total_cgst+$total_sgst+$service_cgst+$service_sgst),2)}}</td>
    ...
    <tr>
      <td colspan="7" style="padding: 10px;">
        <p style="margin: 0; font-weight: bold;padding: 8px 0;">Rupees: <span style="padding: 3px;">{{$rupees}}</span></p>
      ...
      <td valign="bottom">
          ...
          <p style="text-align:right;padding:8px;font-size: 10px;">
    ...
    <tr>
      <td colspan="9" style="text-align: left; padding: 10px;">
        <p style="font-size: small;">Subject to Kolkata Jurisdiction</p>
      </td>
    </tr>
  </table>
