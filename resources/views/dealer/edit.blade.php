...
<section>   
    ...
    <div class="row">
        <div class="col-sm-12">
            <form id="myForm" action="{{ route('dealers.update', [$idStr,$getQueryString]) }}" method="POST">                
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="phone" placeholder="Phone" class="form-control" maxlength="10" value="{{$data->phone}}" onkeypress="validateNum(event)">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="dealer_type" class="form-control" id="dealer_type">
                                        <option value="khosla" @if($data->dealer_type == 'khosla') selected @endif>Khosla</option>
                                        <option value="nonkhosla" @if($data->dealer_type == 'nonkhosla') selected @endif>Non Khosla</option>
                                    </select>
                ...
                <div class="card shadow-sm">
                    <div class="card-body text-end">
                        <a href="{{route('dealers.list')}}?{{$getQueryString}}" class="btn btn-sm btn-danger">Back</a>
