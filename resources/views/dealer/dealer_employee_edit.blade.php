...
<section>    
    <div class="row">
        <div class="col-sm-12">
            <form id="myForm" action="{{ route('dealers.dealer-employee-update',[$idStr,$getQueryString] )}}" method="POST">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="name" placeholder="Name" class="form-control" maxlength="100" value="{{$data->name,old('name')}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="phone" placeholder="Phone" class="form-control" maxlength="10" value="{{$data->phone,old('phone')}}" onkeypress="validateNum(event)">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="branch_name" class="form-control" placeholder="Search showroom ..." onkeyup="searchBranch(this.value);" id="branch_name" value="{{ $data->branchData->name ?? old('branch_name') }}" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="password" autocomplete="off" name="password" placeholder="password" class="form-control" value="{{$data->password,old('password')}}">
                ...
                <div class="card shadow-sm">
                    <div class="card-body text-end">
                        <div class="row align-items-center">
                            <div class="col-auto">
                            <a href="{{route('dealers.dealer-employee-list',[Crypt::encrypt($data->dealer_id),Request::getQueryString()])}}" class="btn btn-sm btn-danger">Back</a>
                            <input type="hidden" name="dealer_id" value="{{$data->dealer_id}}">
