                            ...
                            <div class="col-md-3 div_goods_type">
                                <div class="form-group">
                                    ...
                                    <select name="goods_type" class="form-control" id="goods_type">
										...
										<option value="gas_stove" @if($data->goods_type == 'gas_stove') selected @endif>Gas stove</option>
										<option value="ac" @if($data->goods_type == 'ac') selected @endif>Ac</option>
										<option value="gieger" @if($data->goods_type == 'gieger') selected @endif>Gieger</option>
                                    </select>
                    ...
                    <div class="card-body">
                        <div class="row">     
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-check" id="installable_amount_div" style="display: {{ $errors->has('installable_amount') || $data->is_installable == 1 ? 'block' : 'none' }}">   
                                    <input type="text" class="form-control" name="installable_amount" value="{{$data->installable_amount}}" placeholder="Installation amount">  
