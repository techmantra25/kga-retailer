            ...
            <div class="col-sm-12">                
                        ...
                        <table class="table" id="timePriceTable">
                            ...
                            <tbody>    
                                ...
                                <tr id="tr_{{$key}}" class="tr_pro">
                                    <td class="f-12">
                                        <input type="text" class="form-control" id="product{{$key}}" onkeyup="getProducts(this.value,{{$key}},'sp');" placeholder="Search product ... " name="details[{{$key}}][product]" value="{{ old('details.'.$key.'.product') }}" style="width: 350px" autocomplete="off">
                                ...
                                <tr id="tr_1" class="tr_pro">
                                    <td class="f-12">
                                        <input type="text" class="form-control" id="product1" onkeyup="getProducts(this.value,1,'sp');" placeholder="Search product ... " name="details[1][product]" style="width: 350px" autocomplete="off">
                ...
                <div class="card shadow-sm">
                    <div class="card-body text-end">
                        ...
                        <a href="{{route('return-spares.add')}}?service_partner_id={{$service_partner_id}}" class="btn btn-sm btn-warning">Reset Items</a>
...
<script>
    ...
    $(document).on('click','.addNewTime',function(){
        ...
        <tr id="tr_`+i+`" class="tr_pro">
            <td class="f-12">
                <input type="text" class="form-control" id="product`+i+`" placeholder="Search product ... " onkeyup="getProducts(this.value,`+i+`,'sp');" name="details[`+i+`][product]" style="width: 350px" autocomplete="off">
