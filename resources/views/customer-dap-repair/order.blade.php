    ...
    <section class="feedback-section">
        <div class="feedback-inner">
            <div class="top-header">
                ...
                <h2>Hello, <span>{{$data->customer_name}}</span></h2>
            </div>
            <div class="bottom-body">
                ...
                @if (!empty($errMsg))
                    <div class="price_card">
                        <h3>{{$errMsg}}</h3>
                        <h3>Please visit our website <a href="https://kgaelectronics.com">Click here</a> </h3>
                    </div>                    
                @else
                    
                    <form id="myForm" method="POST" action="{{ route('customer-payment.dap-submit') }}">
                        @csrf
                        ...
                        <table class="table">
                            ...
                            {{-- <tbody>
                                ...
                                @forelse ($data->spares as $spare)
                                <tr>
                                    <th>{{$spare->spares->title}}</th>
                                    <td>{{$spare->quantity}} - ₹ {{$spare->price}}</td>
                                </tr>
                                @empty
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    @if (!empty($data->total_service_charge))
                                    <td align="right">
                                    ...
                                    @else
                                    <td align="right">
                                        <span>No service charge added</span>
                                    </td>
                                    @endif
