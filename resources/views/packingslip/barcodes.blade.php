...
<section>
    <ul class="breadcrumb_menu">
        <li>Goods & Spare Order Management</li>
        <li><a href="{{ route('packingslip.list') }}">Packing Slips</a> </li>
        <li>{{$slipno}}</li>
            ...
            <div class="col-auto">
                ...
                <div class="row g-3 align-items-center">  
                    <div class="col-auto">
                        ...
                        <a href="{{ route('packingslip.barcode-csv',Crypt::encrypt($id)) }}?search={{$search}}" id=""  class="btn btn-outline-primary select-md">Export Barcode CSV</a>
        ...
        <div class="row">
            ...
            <div class="col-12 page_bar">
                <div class="barcode_image" style="margin: 0 auto 4px">
                    ...
                    <span title="{{$item->barcode->barcode_no}}">
                        {!! $item->barcode->code_html !!}
