            ...
            <div class="col-auto">
                ...
                <div class="row g-3 align-items-center">  
                    <div class="col-auto">
                        ...
                        <a href="{{ route('purchase-order.barcode-number-pdf', Crypt::encrypt($id)) }}" class="btn btn-outline-primary select-md">Download Barcode No PDF</a>
                        <a href="{{ route('purchase-order.barcode-csv',Crypt::encrypt($id)) }}?search={{$search}}" id=""  class="btn btn-outline-primary select-md">Export Barcode CSV</a>
                        <a href="{{ route('purchase-order.list') }}" class="btn btn-outline-danger select-md">Back</a>
