...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body >
        ...
        @php
		    ...
		    $accessCustomerPointRepair = userAccess(Auth::user()->role_id,18);
			$accessCustomerDeadSpare = userAccess(Auth::user()->role_id,19);
		    $accessSalesReturn = userAccess(Auth::user()->role_id,20);
        @endphp
