@extends('layouts.app')
@section('content')
@section('page', 'Book an Installation')
<section>   
    <ul class="breadcrumb_menu">  
        <li>Service Partner Management</li>      
        <li><a href="{{ route('installation.list') }}">Installation Request</a> </li>
        <li>Book an Installation</li>
    </ul>
    <div class="row">
        <form id="myForm" action="{{ route('installation.save') }}" enctype="multipart/form-data" method="POST">
            @csrf
            ...
            <div class="col-sm-12">  
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="">Customer Pin Code<span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" max="{{date('Y-m-d')}}" name="delivery_date" class="form-control" id="" value="{{old('delivery_date')}}">  
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Customer Mobile No" name="mobile_no" class="form-control" maxlength="10" id="" value="{{old('mobile_no')}}">    
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Salesman Name" name="salesman" class="form-control" id="" value="{{old('salesman')}}">     
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Salesman Phone No" name="salesman_mobile_no" class="form-control" id="" maxlength="10" value="{{old('salesman_mobile_no')}}">   
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Product Name" onkeyup="searchProduct(this.value);"  name="product_name" value="{{old('product_name')}}" maxlength="200" class="form-control" id="product_name">
