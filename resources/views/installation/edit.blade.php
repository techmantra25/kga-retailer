@extends('layouts.app')
@section('content')
@section('page', 'Installation - Edit Call')
<section>   
    <ul class="breadcrumb_menu">  
        <li>Service Partner Management</li>      
        <li><a href="{{ route('installation.list') }}">Installation Request</a> </li>
        <li>Edit Call</li>
    </ul>
    <div class="row">
        <form id="myForm" action="{{ route('installation.update',[$idStr,$getQueryString]) }}" enctype="multipart/form-data" method="POST">
            @csrf
            ...
            <div class="col-sm-12">  
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @else
                                    <input type="text" autocomplete="off" class="form-control" id="dealer_name" onkeyup="searchDealerUser(this.value);" placeholder="Search dealer user ... " name="dealer_name" value="{{ (!empty($data->dealer_id))?getSingleAttributeTable('dealers','id',$data->dealer_id,'name'):'' }}">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                @if (old('pincode'))
                                    <input type="text" autocomplete="off" placeholder="Enter PIN Code" maxlength="6" name="pincode" class="form-control" onkeyup="getServicePartners(this.value);" id="pincode" value="{{ old('pincode') }}" onkeypress="validateNum(event)"> 
                                    @error('pincode') <p class="small text-danger">{{ $message }}</p> @enderror  
                                @else
                                    <input type="text" autocomplete="off" placeholder="Enter PIN Code" maxlength="6" name="pincode" class="form-control" onkeyup="getServicePartners(this.value);" id="pincode" value="{{$data->pincode}}" onkeypress="validateNum(event)"> 
                                @endif
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="goods_type" class="form-control" id="goods_type">
                                    <option value="general" @if($data->product->goods_type == 'general') selected @endif>General</option>    
                                    <option value="chimney" @if($data->product->goods_type == 'chimney') selected @endif>Chimney</option>    
                                </select>                        
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @if (old('service_partner_id'))
                                    ...
                                    <input type="text" autocomplete="off" name="service_partner_name" class="form-control" id="service_partner_name" value="{{ old('service_partner_person_name') }} | {{ old('service_partner_company_name') }}" onkeyup="searchServicePartner(this.value);" placeholder="Search service partner ... ">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Bill No" name="bill_no" class="form-control" maxlength="100" id="" value="{{$data->bill_no}}" disabled>        
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" max="{{date('Y-m-d')}}" name="delivery_date" class="form-control" id="" value="{{$data->delivery_date}}" >  
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Bill Value" name="product_value" class="form-control" id="" value="{{$data->product_value}}" disabled> 
                            </div>
                        </div>                                                                       
                    </div> 
					</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Customer Full Name" name="customer_name" class="form-control" maxlength="250" id="" @if(old('customer_name')) value="{{ old('customer_name') }}"  @else  value="{{ $data->customer_name }}" @endif >  
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Customer Mobile No" name="mobile_no" class="form-control" maxlength="10" id="" @if(old('mobile_no')) value="{{ old('mobile_no') }}"  @else  value="{{ $data->mobile_no }}" @endif >    
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Salesman Name" name="salesman" class="form-control" id="" value="{{$data->salesman}}" disabled>     
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Salesman Phone No" name="salesman_mobile_no" class="form-control" id="" maxlength="10" value="{{$data->salesman_mobile_no}}" disabled>   
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                <label for="">Name <span class="text-danger">*</span></label>
                                <input type="hidden" name="product_id" id="product_id" value="{{$data->product_id}}" readonly>
                                <input type="text" autocomplete="off" placeholder="Enter Product Name"   name="product_name" value="{{$data->product_name}}" disabled maxlength="200" class="form-control" id="product_name">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" placeholder="Enter Product Serial No" name="product_sl_no" maxlength="100" class="form-control" id="" value="{{$data->product_sl_no}}" disabled> 
                ...
                <div class="card shadow-sm">
                    <div class="card-body text-end">
                        <a href="{{route('installation.list')}}" class="btn btn-sm btn-danger">Back</a>
