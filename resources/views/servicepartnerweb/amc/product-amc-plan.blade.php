...
<section>
    <ul class="breadcrumb_menu d-flex justify-content-between">        
        ...
        <a href="{{ route('servicepartnerweb.amc.add') }}" class="btn btn-outline-primary btn-sm">Back</a>
    </ul>
    <form action="" id="searchForm">
        <div class="search__filter">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto">
                    <a href="{{ route('servicepartnerweb.amc.amc-by-product', [$kga_sales_id , Crypt::encrypt($id)]) }}" class="btn btn-outline-warning select-md">Reset</a>   
                </div>
    ...
    <table class="table">
        ...
        @forelse ($data as $item)
            <tr>
                ...
                <td><a href="{{ route('servicepartnerweb.amc.prepare-for-purchase-amc-plan', [$kga_sales_id , Crypt::encrypt($item->id)]) }}" class="btn btn-outline-primary select-md">Buy</a></td>
            </tr>
