                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="card-body text-end">
                                <a href="{{ route('servicepartnerweb.amc.add') }}" class="btn btn-outline-warning ">Reset Search</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if(!in_array($item->serial, $AmcSubscriptionSerials))
                                    <a href="{{ route('servicepartnerweb.amc.amc-by-product',[$item->id, Crypt::encrypt($item->product_id)])  }}" class="btn btn-outline-primary select-md">View Amc Plan</a>
                                @else
                                    @php
