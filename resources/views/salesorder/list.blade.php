@extends('layouts.app')
@section('content')
@section('page', 'Goods & Spare Order Management')
<section>
            ...
            <div class="col">
                <ul>
                    ...
                    <li @if($status == 'ongoing') class="active" @endif>
                        <a href="{{ route('sales-order.list', ['status'=>'ongoing']) }}">Ongoing <span class="count">({{$countOngoing}})</span> </a>
                    </li>
            ...
            @endphp
                <tr>
                    ...
                    <td>
                        ...
                        <span class="badge bg-info text-dark">{{ ucwords($item->status) }}</span>            
                        @endif
                                
                    </td>
                    <td>
                        @if (in_array($item->status,['pending','ongoing']))
