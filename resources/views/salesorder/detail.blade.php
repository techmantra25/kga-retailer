@extends('layouts.app')
@section('content')
@section('page', 'Spare Order Details')
<section>
            ...
            <div class="card shadow-sm">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            <p><span class="text-muted">Product Type : {{ ($order->type == 'sp')?'Spare Parts':'Finished Goods' }} </span> </p>
                        </div> 
                        <div class="form-group mb-3">
                            <p>Status 
            ...
            <div class="card shadow-sm">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            <p><span class="text-muted">Name : {{$order->dealer->name}} </span> </p>
                        </div> 
                        <div class="form-group mb-3">
                            <p><span class="text-muted">Email : {{$order->dealer->email}} </span> </p>
                        </div> 
                        <div class="form-group mb-3">
                            <p><span class="text-muted">Phone : {{$order->dealer->phone}} </span> </p>
                        </div> 
                    </div>
                </div>  
            </div>                                      
            ...
            <div class="card shadow-sm">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            <p><span class="text-muted">Person Name : {{$order->service_partner->person_name}} </span> </p>
                        </div> 
                        <div class="form-group mb-3">
                            <p><span class="text-muted">Company Name : {{$order->service_partner->company_name}} </span> </p>
                        </div> 
                        <div class="form-group mb-3">
                            <p><span class="text-muted">Email : {{$order->service_partner->email}} </span> </p>
                        </div> 
                        <div class="form-group mb-3">
                            <p><span class="text-muted">Phone : {{$order->service_partner->phone}} </span> </p>
                        </div> 
                    </div>
                </div>  
            </div>                                      
