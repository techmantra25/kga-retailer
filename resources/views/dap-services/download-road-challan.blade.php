            ...
            <tr>
                <td>
                    <div style="text-align: center;">
                        <h3 style="margin: 0px;font-size: 25px;font-weight: 600;">KHOSLA ELECTRONICS PVT.LTD</h3>
                        <p style="margin: 0px;font-size: 18px;font-weight: 600;">15/20 Dhirendra Nath Ghosh Road,
                            Bhawanpur, Kolkate-700025</p>
                        <p style="margin: 0px;font-size: 16px;font-weight: 600;">GSTIN: 19AABCK9715C1ZK Email:
                            khoslaonline@khoslaelectronics.com</p>
                        <p style="margin: 0px;font-size: 16px;font-weight: 600;">Issuing Branch: <span
                                style="font-size: 18px;">{{$data['branch']['name']}}</span></p>
                        <p style="margin: 5px;font-size: 16px;font-weight: 600;">Issuing Branch Phone: <span
                                style="font-size: 18px;">9876543210</span></p>
                        <h3 style="text-decoration: underline;">MATERIAL ISSUE FROM SHOWROOM</h3>
                    </div>
                </td>
            </tr>
                    ...
                    <table style="border-collapse: collapse;width: 100%;" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h5 style="font-size: 16px;margin-bottom: 0;">Date of Challan: <span>{{$date}}</span>
                                    </h5>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <h6 style="max-width: 300px;margin-bottom: 0;"><strong>AMMR TECHNOLOGY LLP</strong>
                                        16 STAND
                                        ROAD,
                                        KOLKATA-700001 <span>GSTIN. 19ABOFAD730E1ZO</span></h6>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top;">
                                    <h6 style="margin-bottom: 0;">Service Center</h6>

                                </td>
                                <td style="vertical-align: top;"><span
                                        style="margin-right: 10px;margin-left:10px;">:</span></td>
                                <td>
                                    <h6 style="margin-bottom: 0;"><strong>{{$data['service_centre']['name']}}</strong></h6>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td style="vertical-align: top;"><span
                                        style="margin-right: 10px;margin-left: 10px;">:</span></td>
                                <td >
                                    <h6 style=" margin-bottom: 0;">{{$data['vehicle_number']}}</h6>
                                </td>
                                <td></td>
                            </tr>
                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="7">
                                                    ...
                                                    <tr>
                                                        <td style="font-size:13px; min-width:400px;"><strong style="font-size:14px;">Narration:</strong> {{$data['issue']}} </td>
                                                        <td style="font-size:13px;"><strong style="font-size:14px;">Total : <span class="text-change" style="font-family: DejaVu Sans, sans-serif;">&#x20A6;</span> (incl. all Taxes)</strong> {{$data['product']['mop']}} </td>
                                                    </tr>
