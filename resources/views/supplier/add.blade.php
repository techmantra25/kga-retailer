                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="public_name" placeholder="Please Enter Public Name" class="form-control" maxlength="100" value="{{old('public_name')}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="email" placeholder="Please Enter Email" class="form-control" maxlength="100" value="{{old('email')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="phone" placeholder="Please Enter Phone" class="form-control" maxlength="10" value="{{old('phone')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">  
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="pin" placeholder="Please Enter PIN Code" class="form-control" maxlength="10" value="{{old('pin')}}">
