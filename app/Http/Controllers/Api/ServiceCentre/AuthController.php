...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $validator = Validator::make($request->all(),[
            'phone' => 'required|exists:service_centers,phone',
            'password' => 'required',
        ...
        if (!$validator->fails()){
            ...
            $checkUser = ServiceCentre::where('phone',$phone)->first();
            if(!empty($checkUser)){
                ...
                if($checkPassword){
                    ...
                    ServiceCentre::where('id',$checkUser->id)->update([
    ...
    public function logout(Request $request)
    {
        ...
        if (! $request->hasHeader('Authorizations')) {
            ...
            try {
                ...
                $user = ServiceCentre::find($user_id);
                
                ServiceCentre::where('id',$user_id)->update([
                    'mac_address' => null
                ]);
